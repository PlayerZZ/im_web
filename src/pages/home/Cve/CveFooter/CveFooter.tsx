...
import { base64toFile, contenteditableDivRange, events, im, isSingleCve, move2end } from "../../../../utils";
...
import { switchUpload } from "../../../../utils/common";
  ...
  const forEachImgMsg = () => {
    ...
    if (screenshotEls.length > 0) {
      ...
      screenshotEls.map(async (snel) => {
        ...
        const { data:{URL} } = await switchUpload(item as any,minioUploadType.file,true);
